...
public class AppCollection {
    ...
    public static void main(String[] args) {
        Student student1 = new Student("Max", SexOfStudent.MALE, 17, 1, 603321.0);
        ...
        Student studentQ = new Student("Max", SexOfStudent.MALE, 12, 1, 603321.0);
        Student studentW = new Student("Ivan", SexOfStudent.MALE, 1321, 4, 6011.0);
        Student studentE = new Student("Susan", SexOfStudent.FEMALE, 18121, 3, 210.0);
        Student studentR = new Student("Den", SexOfStudent.MALE, 11, 5, 00.0);
